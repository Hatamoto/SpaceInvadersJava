...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        this(new VirtualViewport(SpaceInvaders.WIDTH, SpaceInvaders.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(SpaceInvaders.WIDTH, SpaceInvaders.HEIGHT);
